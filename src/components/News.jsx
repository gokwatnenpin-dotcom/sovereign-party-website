      ...
      <div ref={ref} className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-3">
          {NEWS.map((n, i) => (
            <article
              key={n.title}
              className="reveal group flex flex-col overflow-hidden border border-line bg-paper transition-all hover:-translate-y-1 hover:shadow-card"
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-6">
                <h3 className="font-display text-[20px] font-bold leading-snug text-ink transition-colors group-hover:text-accent">
                  {n.title}
                </h3>
                ...
                <a
                  ...
                  className="mt-4 inline-flex items-center gap-1 text-[13px] font-bold uppercase tracking-[1px] text-accent transition-colors hover:text-accent-ink hover:underline"
